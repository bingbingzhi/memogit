...
print(classification_report(y2_train, y2_predTrain,digits=3))
...
print(classification_report(y_test,y1predTest,digits=3))
...
def plot_confusion_matrix(y_test, y1predTest, classes,
    ...
    if not title:
        if normalize:
            ...
            title = 'TWO BINARY MODELS \n Accuracy = 0.71   Micro avg. F1 = 0.72'   
...
plot_confusion_matrix(y_test, y1predTest, classes=['Past','Fut','Pres'], normalize=True,
                      title=None)
plt.savefig('2binary_w.png',dpi=200)
